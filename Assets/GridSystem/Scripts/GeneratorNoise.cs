...
{
    public class GeneratorNoise : MonoBehaviour
    {
        public float[] GenerationNoise(int width, int height, int seed, float scale, int octaves, float persistence, float lacunarity, Vector2 offset)
        {
